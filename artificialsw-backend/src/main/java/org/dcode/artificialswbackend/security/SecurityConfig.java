...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/signup", "/api/login", "/api/family", "/api/mypage", "/api/mypage/edit", "/api/mypage/comments", "/api/mypage/questions", "/api/tree/**", "/api/book/**", "/api/community/**", "/api/puzzle/**", "/api/notification/**").permitAll()
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.addAllowedOriginPattern("*"); // 모든 Origin 허용 (실서비스는 도메인 제한 추천)
